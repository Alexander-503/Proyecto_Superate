...
<html lang="en">
  <head>
    ...
    <title>Universidad Pedagógica de El Salvador</title>
    ...
    <link rel="shortcut icon" href="../images/uped.jpg"/>
...
<main>
  ...
  <div class="container px-4 py-5" id="featured-3" align="center">
    <h2 class="pb-2 border-bottom">Universidad Pedagógica de El Salvador</h2>
  ...
  <div class="container px-4 py-5" id="hanging-icons">
    <font face="Franklin Gothic"><h2 class="pb-2 border-bottom">Información</h2></font><br>
        ...
        <div>
          <font face="Cambria">
          <p><h4>La Universidad Pedagógica de El Salvador surge como un centro de enseñanza superior con una mística y sello de trabajo que se caracteriza por la formación técnica, científica y humanística de recursos humanos en las diversas áreas del conocimiento del ámbito profesional; funciona bajo sistemas pedagógicos modernos cuya visión general de la educación es la de un proceso esencial para la formación integral de los diferentes profesionales. De ahí el nombre que la Universidad actualmente ostenta: UNIVERSIDAD PEDAGÓGICA DE EL SALVADOR.
          Fundada en la ciudad de San Salvador, se firma su Acta de Constitución el 16 de marzo de 1982 y es el 26 de julio de 1982 que son aprobados sus Estatutos, según acuerdo No. 2239 del Ramo de Educación, día en que la universidad celebra su aniversario.</p><Br></h4>
            ...
            <div class="card mb-3" style="max-width: 1200px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="../images/uped.jpg" class="img-fluid rounded-start" align="center">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title"></h5>
                      <p class="card-text"><p><strong><h4>Licenciaturas en:</strong>
                        <br>
                        -Educación Inicial y Parvularia<Br>
                        -Trabajo Social<Br>
                        -Psicología<Br>
                            <Br>
                        <strong>Licenciaturas en ciencias de la educación Especialidad en:</strong><Br>
                        -Educación Física y Deportes<Br>
                        -Educación Básica para Primero y Segundo Ciclo<Br>
                        -Matemática<Br>
                        -Idioma Inglés<Br>
                        -Ciencias Naturales<Br>
                        -Lenguaje y Literatura<Br>
                        -Ciencias Sociales<Br><br>

                        <strong>Profesorados:</strong><Br>
                        -Educación Inicial y Parvularia<Br>
                        -Educación Básica para Primero y Segundo Ciclo<Br>
                        -Educación Física y Deporte<Br><br>
                        
                        <strong>Para Tercer Ciclo de Educación Básica y Educación Media:</strong><Br>
                        -Lenguaje y Literatura<Br>
  ...
  <div class="container px-4 py-5" id="hanging-c">
    ...
    <center><img src="../images/contacto10.png"></center>
       </div>
    </div>
  </div>
