...
<main>
  ...
  <div class="container px-4 py-5" id="hanging-icons">
    <font face="Franklin Gothic"><h2 class="pb-2 border-bottom">Información</h2></font><br>
        ...
        <div>
          <font face="Cambria">
          <p><h4>La visión de Universidad Panamericana es fortalecer su carácter educativo para competir
            con otras universidades del mundo, en la formación profesional responsable y capaz de que
            sirvan al desarrollo del país en las diferentes áreas donde se desenvuelvan, buscando las
            mejores alternativas de solución en las diversas problemáticas que se presenten</p><Br></h4>
