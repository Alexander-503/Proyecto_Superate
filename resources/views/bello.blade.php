...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="../images/andres.png"/>
...
<main>
  ...
  <div class="container px-4 py-5" id="featured-3" align="center">
    <h2 class="pb-2 border-bottom">Universidad Dr. Andrés Bello</h2>
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      <div class="feature col">
        ...
        <a href="https://www.unab.edu.sv/facultades/ciencias-de-la-salud/" class="icon-link d-inline-flex align-items-center">
          Ver
  ...
  <div class="container px-4 py-5" id="hanging-icons">
    <font face="Franklin Gothic"><h2 class="pb-2 border-bottom">Información</h2></font><br>
        ...
        <div>
          <font face="Cambria">
          <p><h4>En el año de 1989, con la visión futurista que caracteriza al Dr. H. C. y Lic. Guillermo Escobar Hernández,
          dió inicio la creación de la Universidad Dr. Andrés Bello. Dicha Universidad recibe su autorización, para funcionar
          como institución de nivel superior el 20 de diciembre de 1990, según acuerdo No. 6183, con dicho acuerdo se aprueban
          los estatutos de la UNAB, por el MINED y estos tienen validez hasta la fecha. La UNAB inicia su funcionamiento el 1
          de Febrero de 1991 en la 49 Av. Sur No. 753, Col. Flor Blanca, San Salvador. En la actualidad la UNAB cuenta con la
          cobertura estudiantil de oportunidades de formación a las personas interesadas, la UNAB decide acercar sus servicios
          educativos y crea algunos centros regionales en diferentes puntos de desarrollo del país como San Miguel, Sonsonate
          y Chalatenango, contando así con 4 Campus en todo el país y con más de 25 carreras.</p><Br></h4>
            ...
            <div class="card mb-3" style="max-width: 1000px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="../images/andres.png" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title"></h5>
                      <p class="card-text"><b><p><h4>Enfermería:<br></b>
                        Licenciatura en Enfermería<br>
                        Técnico en Enfermería<br>
                        Tecnólogo en Enfermería<Br>
                          <br>
                        <b>Ciencias de Salud:<Br></b>
                        Licenciatura en Laboratorio Clínico<br>
                        Licenciatura en Nutrición<br>
                        Licenciatura en Radiología e Imágenes<br>
  ...
  <div class="container px-4 py-5" id="hanging">
    ...
    <center><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d992323.7995368547!2d-90.26642229999996!3d13.702403099999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f63305e67626827%3A0xd74261194b306c21!2sUniversidad%20Dr.%20Andr%C3%A9s%20Bello!5e0!3m2!1ses-419!2ssv!4v1669585658201!5m2!1ses-419!2ssv" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></center>
       </div>
  ...
  <div class="container px-4 py-5" id="custom-cards">
    ...
    <div class="card-group">
      <div class="card">
        <img src="../images/be1.jpg" class="card-img-top" height="280">
        <div class="card-body">
      ...
      <div class="card">
        <img src="../images/be2.jpg" class="card-img-top" height="280">
        <div class="card-body">
      ...
      <div class="card">
        <img src="../images/be3.jpg" class="card-img-top" height="280">
        <div class="card-body">
