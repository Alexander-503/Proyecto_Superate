...
<html lang="en">
  <head>
    ...
    <title>Escuela Superior de Economía y Negocios</title>
    ...
    <link rel="shortcut icon" href="../images/esen2.png"/>
...
<main>
  ...
  <div class="container px-4 py-5" id="featured-3" align="center">
    <h2 class="pb-2 border-bottom">Escuela Superior de Economía y Negocios</h2>
  ...
  <div class="container px-4 py-5" id="hanging-icons">
    <font face="Franklin Gothic"><h2 class="pb-2 border-bottom">Información</h2></font><br>
        ...
        <div>
          <font face="Cambria">
          <p><h4>a ESEN es una institución de educación superior, privada, sin fines de lucro, ubicada en la ciudad de Santa Tecla, departamento de La Libertad, El Salvador. La ESEN, que nace de un significativo y decisivo esfuerzo de un grupo de empresarios, ofrece tres programas de pregrado, bajo un enfoque de excelencia académica y oportunidad para todos: la Licenciatura en Economía y Negocios (desde 1994), la Licenciatura en Ciencias Jurídicas (desde 2003) y la Ingeniería de Negocios (desde 2009).
          La ESEN cuenta con una población estudiantil de aproximadamente 800 estudiantes, y tiene más de 1500 graduados. En sus primeros años, la ESEN tuvo menos de 10 colaboradores contratados, tres salones de clase, una biblioteca pequeña, un laboratorio de informática con menos de 30 computadoras, un centro de extensión universitaria (el Centro Emprendedor ESEN) y una carrera de pregrado (la Licenciatura en Economía y Negocios). La primera generación de graduados se compuso de 55.</p><Br></h4>
            ...
            <div class="card mb-3" style="max-width: 1200px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="../images/esen2.png" class="img-fluid rounded-start" align="center">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title"></h5>
                      <p class="card-text"> <br><p><strong><h4>ESEN ofece:</strong>
                        <br>
                        -Ingeniería de Negocios <br>
                        -Licenciatura en Ciencias Jurídicas <br>
                        -la Licenciatura en Economía y Negocios.
                        </p></h4>
                    </div>
                  </div>
                </div>
  ...
  <div class="container px-4 py-5" id="hanging">
    ...
    <center><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3877.0399154720094!2d-89.28824928572978!3d13.655335903201918!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f632e8a5ee186a9%3A0xa3b040405dc16503!2sEscuela%20Superior%20de%20Econom%C3%ADa%20y%20Negocios!5e0!3m2!1ses-419!2ssv!4v1669605571054!5m2!1ses-419!2ssv" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></center>
       </div>
