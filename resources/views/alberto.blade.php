...
<html lang="en">
  <head>
    ...
    <title>Universidad Alberto Masferrer</title>
    ...
    <link rel="shortcut icon" href="../images/alber.png"/>
...
<main>
  ...
  <div class="container px-4 py-5" id="featured-3" align="center">
    <h2 class="pb-2 border-bottom">Universidad Alberto Masferrer</h2>
  ...
  <div class="container px-4 py-5" id="hanging-icons">
    <font face="Franklin Gothic"><h2 class="pb-2 border-bottom">Información</h2></font><br>
        ...
        <div>
          <font face="Cambria">
          <p><h4>La Universidad Salvadoreña Alberto Masferrer busca desde el año 2015 
            a través de la Unidad de Formación Continua motivar el deseo de actualización 
            de conocimientos de los salvadoreños e impulsar el desarrollo del recurso más 
            valioso de las empresas, por medio de la promoción de diplomados y cursos 
            especiales en las áreas de negocios, finanzas, marketing, recursos humanos, 
            informática básica, salud y otras.</p><Br></h4>
            ...
            <div class="card mb-3" style="max-width: 900px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="../images/alber.png" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title"></h5>
                      <p class="card-text"> <b><p><h4>Facultad de medicina:</b><br>
                        -Doctorado en Medicina <br>
                        -Licenciatura en Enfermería<Br><br>                                                
                            <b>Facultad de Química y Farmacia:</b><Br>               
                            -Lic. en Química y Farmacia <br>
                            -Técnico en Uso y Manejo de Plantas Medicinales<Br><br>           
                            <b>Facultad de Ciencias Empresariales:</b><Br>              
                            -Lic. en Mercadeo <br>
                            -Lic. en Comunicaciones <br>
                            -Lic. en Contaduría Pública <br>
                            -Lic. en Ciencias de la Computación <br>
                            -Lic. en Administración de Empresas <br>
                            -Tec. en Mercadeo <br>
                            -Tec. en Publicidad<Br></p></h4></p>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <div class="container px-4 py-5" id="hanging">
    ...
    <center><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3876.2615164550666!2d-89.20291038572935!3d13.702604702124715!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f6330f295544717%3A0x4c3f29b822e8ad9c!2sUniversidad%20Salvadore%C3%B1a%20Alberto%20Masferrer!5e0!3m2!1ses-419!2ssv!4v1669592961695!5m2!1ses-419!2ssv" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></center>
       </div>
  ...
  <div class="container px-4 py-5" id="hanging-c">
    <font face="Franklin Gothic"><h2 class="pb-2 border-bottom">Contactos</h2></font><br>
        <center><img src="../images/alber.png" width="150" height="150"></center><br>
        <center><b><p>Direccion:<p></b> <p>19 Av. Norte entre 3ª Calle Poniente y Alameda Juan Pablo II, San Salvador</p>
        <b><p>Telefono:<p></b> <p>2231-9667 o 2231-9698</p>
        <b><p>Email:<p></b> <p>informacion@usam.edu.sv, comunicaciones@usam.edu.sv</p>
        <b><p>Sitio Web:<p></b> <a href=" http://www.usam.edu.sv/usam/"> http://www.usam.edu.sv/usam/</a></center>
       </div>
    </div>
  </div>
