...
<html lang="en">
  <head>
    ...
    <title>Escuela de Comunicación Mónica Herrera</title>
    ...
    <link rel="shortcut icon" href="../images/monica.jpg"/>
...
<main>
  ...
  <div class="container px-4 py-5" id="featured-3" align="center">
    <h2 class="pb-2 border-bottom">Escuela de Comunicación Mónica Herrera</h2>
  ...
  <div class="container px-4 py-5" id="hanging-icons">
    <font face="Franklin Gothic"><h2 class="pb-2 border-bottom">Información</h2></font><br>
        ...
        <div>
          <font face="Cambria">
          <p><h4>En esta escuela unimos la Educación a la vida. Desde los inicios de nuestra institución, el objetivo ha sido aplicar una metodología de aprendizaje centrada en el rigor académico y la aplicación práctica, decidiendo por ello la metodología de aprender haciendo. También tomamos acción para proponer soluciones aplicables y significativas a través de potenciar el talento creativo.
            Con más de 40 años de experiencia como docente e investigadora, Mónica Herrera es la creadora y fundadora de la Escuela de Comunicación que lleva su nombre en Chile, Ecuador y San Salvador. Además, es periodista, magíster en Comunicación Social y doctora en Educación.</p><Br></h4>
            ...
            <div class="card mb-3" style="max-width: 1000px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="../images/monica.png" class="img-fluid rounded-start" align="center">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title"></h5>
                      <p class="card-text"><br><br><p><strong><h4>Monica Herrrera ofece:</strong>
                        <br>
                        -Licenciatura en comunicación y estrategía digital <br>
                        -Licenciatura en diseño estrategco <br>
  ...
  <div class="container px-4 py-5" id="hanging">
    ...
    <center><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3876.682635292117!2d-89.29225448401462!3d13.677051876506292!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f632efec06422ad%3A0x35fe7997d4709b1a!2sEscuela%20de%20Comunicaci%C3%B3n%20M%C3%B3nica%20Herrera!5e0!3m2!1ses-419!2ssv!4v1669607522990!5m2!1ses-419!2ssv" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></center>
       </div>
