...
<html lang="en">
  <head>
    ...
    <title>Universidad Modular Abierta</title>
    ...
    <link rel="shortcut icon" href="../images/uma.jpg"/>
...
<main>
  ...
  <div class="container px-4 py-5" id="featured-3" align="center">
    <h2 class="pb-2 border-bottom">Universidad Modular Abierta</h2>
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      <div class="feature col">
        ...
        <a href="https://www.uma.edu.sv/ccee.html" class="icon-link d-inline-flex align-items-center">
          Ver
  ...
  <div class="container px-4 py-5" id="hanging-icons">
    <font face="Franklin Gothic"><h2 class="pb-2 border-bottom">Información</h2></font><br>
        ...
        <div>
          <font face="Cambria">
          <p><h4>En 1981, año de grandes acontecimientos para la vida política, educativa, cultural 
            y social de El Salvador, fue el momento en que un grupo de profesionales del país, decidieron 
            crear una “nueva” institución que fuera capaz de ofrecer servicios educativos en el Nivel de 
            educación Superior, con calidad y excelencia académica y con el imprescindible componente de 
            accesibilidad a los estudios universitarios para las personas 
            que en esos días solamente podían soñar en convertirse en profesionales útiles a su patria. En la actualidad, la Universidad se encuentra innovando sus enfoques curriculares para dar calidad a las modalidades de educación virtual. En resumen, se puede aseverar, que toda la labor académica y administrativa de la Universidad se encuentra totalmente respaldada en los términos que el marco jurídico salvadoreño lo indica y en consecuencia, todos los títulos, certificados y documentos acreditados que la Universidad extienda a favor de sus graduados cumplen todas las exigencias que las normativas legales exigen a las Instituciones de Educación Superior de El Salvador.        </p><Br></h4>
            ...
            <div class="card mb-3" style="max-width: 1000px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="../images/uma.jpg" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title"></h5>
                      <p class="card-text"><b><p><h4>Facultad de Ciencias Económicas:<br></b>
                        -Técnico en Software <br>
                        -Técnico en Administración de Personal <br>
                        -Técnico en Contaduría Pública <br>
                        -Licenciatura en Informática <br>
                        -Licenciatura en Mercadotecnia <br>
                        -Licenciatura en Contaduría Pública <br>
                        -Licenciatura en Administración de Empresas <br><br>

                        <b>Facultad de Ciencias y Humanidades:</b> <br>
  ...
  <div class="container px-4 py-5" id="hanging">
    ...
    <center><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3876.2614933614923!2d-89.21956768572932!3d13.702606102124639!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f63305e6762eb57%3A0xe8137602b33fb396!2sUniversidad%20Modular%20Abierta!5e0!3m2!1ses-419!2ssv!4v1669590135092!5m2!1ses-419!2ssv" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></center>
       </div>
  ...
  <div class="container px-4 py-5" id="hanging-c">
    <font face="Franklin Gothic"><h2 class="pb-2 border-bottom">Contactos</h2></font><br>
            <center><img src="../images/contacto8.png" alt=""></center>
       </div>
    </div>
  </div>
