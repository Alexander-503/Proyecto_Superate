...
<html lang="en">
  <head>
    ...
    <title>Universidad Politécnica</title>
    ...
    <link rel="shortcut icon" href="../images/pili.png"/>
...
<main>
  ...
  <div class="container px-4 py-5" id="featured-3" align="center">
    <h2 class="pb-2 border-bottom">Universidad Politécnica de El Salvador</h2>
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      <div class="feature col">
        ...
        <a href="http://www.upes.edu.sv/arquitectura/" class="icon-link d-inline-flex align-items-center">
          Ver
        ...
        <div>
          ...
          <p><h4>La UPES fue fundada el 8 de febrero de 1979 por cuarenta profesionales. En sus primeros años la universidad contó con el 
            ...
            <div class="card mb-3" style="max-width: 900px;">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="../images/pili.png" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title"></h5>
                      <p class="card-text"> <b><p><h4><Br>
                        Facultad de Ingienería y Arquitectura<Br>
                            <Br>
                        Facultad de Ciencias Económicas<Br>
                            <Br>
                        Facultad de Ciencias Jurídicas y Sociales></p></h4></p></b>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <div class="container px-4 py-5" id="hanging">
    ...
    <center><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3876.155335793307!2d-89.19620928572925!3d13.70904020197776!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f633093f5014653%3A0x69c904dc54e6ffbb!2sUniversidad%20Polit%C3%A9cnica%20de%20El%20Salvador!5e0!3m2!1ses-419!2ssv!4v1669594773310!5m2!1ses-419!2ssv" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></center>
       </div>
  ...
  <div class="container px-4 py-5" id="custom-cards">
    ...
    <div class="card-group">
      ...
      <div class="card">
        <img src="../images/upes1.jpg" class="card-img-top" height="420">
        <div class="card-body">
  ...
  <div class="container px-4 py-5" id="hanging-c">
    <font face="Franklin Gothic"><h2 class="pb-2 border-bottom">Contactos</h2></font><br>
       <center><img src="../images/contacto9.png" alt=""></center>
       </div>
    </div>
  </div>
